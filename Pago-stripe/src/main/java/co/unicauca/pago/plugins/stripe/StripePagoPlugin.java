...
package co.unicauca.pago.plugins.stripe;
 ...
 * @author usuario
 */
public class StripePagoPlugin implements IPagoPlugin {
    String filePath;
    @Override
    public boolean paySimulated(Pago pago) {
        this.filePath = "datosCuentasStripe.txt"; // Nombre del archivo sin la ruta completa
