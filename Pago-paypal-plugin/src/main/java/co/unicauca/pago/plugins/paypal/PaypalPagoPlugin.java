 ...
 */
package co.unicauca.pago.plugins.paypal;
 ...
 * @author usuario
 */
public class PaypalPagoPlugin implements IPagoPlugin{
    String filePath;
    @Override
    public boolean paySimulated(Pago pago) {
        this.filePath = "datosCuentasPaypal.txt"; // Nombre del archivo sin la ruta completa
